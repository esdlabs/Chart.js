...
x=b.longestText=function(a,b,c){a.font=b;var d=0;e(c,function(b){b=a.measureText(b).width;d=b>d?b:d});return d},C=b.drawRoundedRectangle=function(a,b,c,e,d,f){a.beginPath();a.moveTo(b+f,c);a.lineTo(b+e-f,c);a.quadraticCurveTo(b+e,c,b+e,c+f);a.lineTo(b+e,c+d-f);a.quadraticCurveTo(b+e,c+d,b+e-f,c+d);a.lineTo(b+f,c+d);a.quadraticCurveTo(b,c+d,b,c+d-f);a.lineTo(b,c+f);a.quadraticCurveTo(b,c,b+f,c);a.closePath()};c.instances={};c.Type=function(a,b,e){this.options=b;this.chart=e;this.id=F();c.instances[this.id]=
...
a;this.draw();this.options.customTooltips&&this.options.customTooltips(!1);if(0<a.length)if(this.datasets&&1<this.datasets.length){for(var d,f,g=this.datasets.length-1;0<=g&&(d=this.datasets[g].points||this.datasets[g].bars||this.datasets[g].segments,f=E(d,a[0]),-1===f);g--);var m=[],k=[];d=function(a){var c=[],e,h=[],d=[],l,g,y;b.each(this.datasets,function(a){e=a.points||a.bars||a.segments;e[f]&&e[f].hasValue()&&c.push(e[f])});b.each(c,function(a){h.push(a.x);d.push(a.y);m.push(b.template(this.options.multiTooltipTemplate,
a));k.push({fill:a._saved.fillColor||a.fillColor,stroke:a._saved.strokeColor||a.strokeColor})},this);y=t(d);l=v(d);g=t(h);a=v(h);return{x:g>this.chart.width/2?g:a,y:(y+l)/2}}.call(this,f);(new c.MultiTooltip({x:d.x,y:d.y,xPadding:this.options.tooltipXPadding,yPadding:this.options.tooltipYPadding,xOffset:this.options.tooltipXOffset,fillColor:this.options.tooltipFillColor,textColor:this.options.tooltipFontColor,fontFamily:this.options.tooltipFontFamily,fontStyle:this.options.tooltipFontStyle,fontSize:this.options.tooltipFontSize,
...
this.fit()},draw:function(){var a=this.ctx,c=(this.endPoint-this.startPoint)/this.steps,d=Math.round(this.xScalePaddingLeft);if(this.display){a.fillStyle=this.textColor;a.font=this.font;e(this.yLabels,function(e,f){var g=this.endPoint-c*f,m=Math.round(g),k=this.showHorizontalLines;a.textAlign="right";a.textBaseline="middle";this.showLabels&&a.fillText(e,d-10,g);0!==f||k||(k=!0);k&&a.beginPath();0<f?(a.lineWidth=this.gridLineWidth,a.strokeStyle=this.gridLineColor):(a.lineWidth=this.lineWidth,a.strokeStyle=
this.lineColor);m+=b.aliasPixel(a.lineWidth);k&&(a.moveTo(d,m),a.lineTo(this.width,m),a.stroke(),a.closePath());a.lineWidth=this.lineWidth;a.strokeStyle=this.lineColor;a.beginPath();a.moveTo(d-5,m);a.lineTo(d,m);a.stroke();a.closePath()},this);this.xLabelsSkipper=p(this.showXLabels)?Math.ceil(this.xLabels.length/this.showXLabels):!0===this.showXLabels?1:this.xLabels.length+1;var f=this;e(this.xLabels,function(b,c){var e=this.calculateX(c)+A(this.lineWidth),d=this.calculateX(c-(this.offsetGridLines?
.5:0))+A(this.lineWidth),h=0<this.xLabelRotation,g=this.showVerticalLines;0!==c||g||(g=!0);g&&a.beginPath();0<c?(a.lineWidth=this.gridLineWidth,a.strokeStyle=this.gridLineColor):(a.lineWidth=this.lineWidth,a.strokeStyle=this.lineColor);g&&(a.moveTo(d,this.endPoint),a.lineTo(d,this.startPoint-3),a.stroke(),a.closePath());a.lineWidth=this.lineWidth;a.strokeStyle=this.lineColor;0===c%f.xLabelsSkipper&&(a.beginPath(),a.moveTo(d,this.endPoint),a.lineTo(d,this.endPoint+5),a.stroke(),a.closePath());a.save();
a.translate(e,h?this.endPoint+12:this.endPoint+8);a.rotate(-1*w(this.xLabelRotation));a.font=this.font;a.textAlign=h?"right":"left";a.textBaseline=h?"middle":"top";0===c%f.xLabelsSkipper&&a.fillText(b,0,0);a.restore()},this)}}});c.RadialScale=c.Element.extend({initialize:function(){this.size=t([this.height,this.width]);this.drawingArea=this.display?this.size/2-(this.fontSize/2+this.backdropPaddingY):this.size/2},calculateCenterOffset:function(a){return this.drawingArea/(this.max-this.min)*(a-this.min)},
...
e,d=this.width,f,g=0,m;this.ctx.font=r(this.pointLabelFontSize,this.pointLabelFontStyle,this.pointLabelFontFamily);for(c=0;c<this.valuesCount;c++)b=this.getPointPosition(c,a),e=this.ctx.measureText(q(this.templateString,{value:this.labels[c]})).width+5,0===c||c===this.valuesCount/2?(e/=2,b.x+e>d&&(d=b.x+e,f=c),b.x-e<g&&(g=b.x-e,m=c)):c<this.valuesCount/2?b.x+e>d&&(d=b.x+e,f=c):c>this.valuesCount/2&&b.x-e<g&&(g=b.x-e,m=c);b=g;d=Math.ceil(d-this.width);f=this.getIndexAngle(f);m=this.getIndexAngle(m);
